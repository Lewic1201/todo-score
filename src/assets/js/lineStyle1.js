...
!function (e) {
  ...
  u.m = e, u.c = o, u.d = function (e, t, n) {
    ...
    if (u.r(n), Object.defineProperty(n, "default", {
      enumerable: !0,
      value: e
    }), 2 & t && "string" != typeof e) for (var o in e) u.d(n, o, function (t) {
      return e[t]
    }.bind(null, o));
    return n
  }, u.n = function (e) {
  ...
  28: function (e, t, n) {
    "use strict";
    n.r(t);
    var o, r, i = n(1), u = n(13), a = n(7), c = n(8), f = n(6), l = n(10), p = n(9), s = n(15), y = n(2), b = n(4);
    n(29);
    ...
    var P = new (o = Object(a.a)({x: 2, y: 3}, .05), Object(c.a)(r = o(r = function (e) {
      function t() {
        return O(this, t), w(this, g(t).apply(this, arguments))
      }

      return j(t, f["a"]), t
    }()) || r) || r), S = new l.a("+|=*_*=|+", {color: "#dc2c5a", size: b.a.isMobile ? .4 : .8});
    ...
    M.to(".overlay", 2, {opacity: 0}), M.to(".background", 2, {y: -300}, 0), M.fromTo(P.lookAt, 2, {y: -8}, {
      y: 0,
      ease: Power2.easeOut
      ...
      }), t.add(S.hide, 0), t.add(x.stop), t.to(".overlay", .5, {autoAlpha: 1, onComplete: e}, "-=1.5")
    })
  }, 29: function (e, t, n) {
  }
});
